...
@Composable
private fun VolumeChannelSection(
    viewModel: RemoteViewModel,
    scaleFactor: Float,
) {
    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
...
private fun MediaTransportRow(
    ...
    val buttons =
        listOf<Triple<androidx.compose.ui.graphics.vector.ImageVector, () -> Unit, Boolean>>(
...
private fun MenuInfoGrid(
    ...
    val items =
        listOf<Pair<androidx.compose.ui.graphics.vector.ImageVector, RemoteKey>>(
